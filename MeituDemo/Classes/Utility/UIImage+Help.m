...
//    NSURL *url = [[bundle resourceURL]URLByAppendingPathComponent:@"MeituDemo.bundle/MeituDemo.bundle"];
    NSBundle * bundleee = [NSBundle bundleWithURL:[[[NSBundle bundleForClass:[ZYQAssetPickerController class]] resourceURL]URLByAppendingPathComponent:@"MeituDemo.bundle/MeituDemo.bundle"]];
    UIImage* image = [UIImage imageWithContentsOfFile:[bundleee.resourcePath stringByAppendingPathComponent:imageName]];
