...
- (void)setupButtons
{
    ...
    [[UIBarButtonItem alloc] initWithTitle:@"card_meitu_cancel"
...
- (void)didSelectAsset:(ALAsset *)asset
{
    ...
    [self.preView addImageWith:asset];
...
- (void)didDeselectAsset:(ALAsset *)asset
{
    ...
    [self.preView deletePintuAction:asset];
//    [self setTitleWithSelectedIndexPaths:_indexPathsForSelectedItems];
...
- (NSString *)accessibilityLabel
{
    ...
    return [label stringByAppendingFormat:@"card_meitu_imagegroup_imagecount", (long)[self.assetsGroup numberOfAssets]];
}
