...
{
    self.title = @"card_select_image_pingtu";
    ...
    [backButton setImage:[UIImage getImage:@"icon_ios7_back"] forState:UIControlStateNormal];
...
- (void)initBoardAndEditView
{
    ...
    [self.boardbutton setBackgroundImage:[UIImage getImage:@"btn_meitu_board_normal"] forState:UIControlStateNormal];
    [self.boardbutton setBackgroundImage:[UIImage getImage:@"btn_meitu_board_highlight"] forState:UIControlStateHighlighted];
    [self.boardbutton setBackgroundImage:[UIImage getImage:@"btn_meitu_board_highlight"] forState:UIControlStateSelected];
    
    [self.editbutton setBackgroundImage:[UIImage getImage:@"btn_meitu_edit_normal"] forState:UIControlStateNormal];
    [self.editbutton setBackgroundImage:[UIImage getImage:@"btn_meitu_edit_highlight"] forState:UIControlStateHighlighted];
    [self.editbutton setBackgroundImage:[UIImage getImage:@"btn_meitu_edit_highlight"] forState:UIControlStateSelected];
...
- (void)boardButtonAction:(id)sender
{
    ...
    if (_selectControlButton.tag == 1) {
        [_meituContentView setBackgroundColor:[UIColor whiteColor] posterImage:[UIImage getImage:@"testBoder_1.png"]];
    }else if(_selectControlButton.tag == 3){
        [_spliceView setBoarderImage:[UIImage getImage:@"testBoder_2.png"]];
    }
