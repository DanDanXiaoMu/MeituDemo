...
- (void)initResource
{
    ...
    for (int i = 0; i < [imageNameArray count]; i++) {
        ...
        [button setImage:[UIImage getImage:[imageNameArray objectAtIndex:i]] forState:UIControlStateNormal];
        [button setBackgroundImage: [UIImage getImage: @"makecards_puzzle_storyboard_strokr_icon"] forState:UIControlStateHighlighted];
        [button setBackgroundImage:[UIImage getImage: @"makecards_puzzle_storyboard_strokr_icon"] forState:UIControlStateSelected];
